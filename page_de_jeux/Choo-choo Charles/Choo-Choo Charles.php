...
<html lang="fr" dir="ltr">
    <head>
       ...
       <!--<link rel="icon" href="images/Doom_Eternal_Logo.png">-->
        <link rel="stylesheet" href="Choo-Choo Charles.css">
...
?>
                ...
                <a href="https://store.steampowered.com/app/782330/DOOM_Eternal/" ><img id="Logo" src="images/choo-choo-charles-logo.png"></a>
                <?php
    ...
    echo '<table>';
    $result = $db->query('SELECT * FROM "Resultat_Choo-Choo Charles"'); //changer par le nom du jeux dans la table
