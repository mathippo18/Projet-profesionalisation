...
<html lang="fr" dir="ltr">
    <head>
        ...
        <link rel="stylesheet" href="Mario Galaxy.css">
...
?>
                ...
                <a href="https://store.steampowered.com/app/782330/DOOM_Eternal/" ><img id="SMG_Logo" src="images/SMG_Logo.png"></a>
                <?php
    ...
    echo '<table>';
    $result = $db->query('SELECT * FROM "Resultat_Mario Galaxy"'); //changer par le nom du jeux dans la table
