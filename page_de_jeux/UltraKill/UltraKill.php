...
<html lang="fr" dir="ltr">
    <head>
        ...
        <link rel="stylesheet" href="UltraKill.css">
...
?>
                ...
                <a href="https://store.steampowered.com/app/782330/DOOM_Eternal/" ><img id="UltraKill_logo" src="images/UltraKill_logo.png"></a>
                <?php
    ...
    echo '<table>';
    $result = $db->query('SELECT * FROM "Resultat_UltraKill"'); //changer par le nom du jeux dans la table
