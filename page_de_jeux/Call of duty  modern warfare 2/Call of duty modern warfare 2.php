...
<html lang="fr" dir="ltr">
    <head>
       ...
       <!-- <link rel="icon" href="images/Doom_Eternal_Logo.png">-->
        <link rel="stylesheet" href="Call of duty modern warfare 2.css">
...
?>
                ...
                <a href="https://store.steampowered.com/app/782330/DOOM_Eternal/" ><img id="Logo" src="images/OIP.png"></a>
                <?php
    ...
    echo '<table>';
    $result = $db->query('SELECT * FROM "Resultat_C ll of duty : MWII"'); //changer par le nom du jeux dans la table
