...
?>
                ...
                <a href="https://store.steampowered.com/app/782330/DOOM_Eternal/" ><img id="MC_Logo" src="images/MC_logo.png"></a>
                <?php
    ...
    echo '<table>';
    $result = $db->query('SELECT * FROM "Resultat_Minecraft"'); //changer par le nom du jeux dans la table
